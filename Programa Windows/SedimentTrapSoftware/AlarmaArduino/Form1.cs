...
namespace AlarmaArduino
{
    public partial class ComunicacionArduino : Form
    {
        ...
        */
            ...
            else
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        fWriter.Flush();
                        fWriter.Close();
                        MessageBox.Show("Fichero de texto guardado correctamente en \n" + fullname, @"Fichero guardado",
                            MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void tiempoEntreFechasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DialogResult TiempoFechas = MessageBox.Show(
                "La fecha máxima entre muestras es de 30 días, si desea cambiar este tiempo haga click en aceptar",
                "Cambiar tiempo entre fechas", MessageBoxButtons.OKCancel, MessageBoxIcon.Exclamation,
                MessageBoxDefaultButton.Button2);
            if (TiempoFechas==DialogResult.OK)
            {
                var frm = new About();
                frm.Show();

                var frmFechas = new TiempoFechas();
                frmFechas.Show();
                MessageBox.Show("Cambiando fechas");
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Para evitar errores, reinicie el programa, su configuración se encontrará almacenada",
                "Configuración guardada, debe de reiniciar el programa", MessageBoxButtons.OK,
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Settings.Default.Save();
            MessageBox.Show("Configuración original reestablecida; para evitar errores, reinicie el programa, su configuración se encontrará almacenada",
                "Configuración guardada, debe de reiniciar el programa", MessageBoxButtons.OK,
                MessageBoxIcon.Exclamation);
        }
    }
